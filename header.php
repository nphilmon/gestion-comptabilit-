...
<head>
    ...
    <link href="https://fonts.googleapis.com/css2?family=Roboto:wght@300;400;500;600;700&family=Roboto+Mono:wght@400;600;700&display=swap" rel="stylesheet">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark navbar-blue">
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                ...
                <!-- Recherche globale -->
                <form class="d-none d-lg-flex me-3 position-relative" action="<?= BASE_URL ?>recherche.php" method="GET" autocomplete="off">
                    <div class="input-group input-group-sm" style="width: 220px;">
                        <input type="text" class="form-control bg-white bg-opacity-10 text-white border-light border-opacity-25" 
                               name="q" placeholder="Rechercher..." id="searchGlobal"
                               style="font-size: 0.85rem;"
                               value="<?= e($_GET['q'] ?? '') ?>">
                        <button class="btn btn-outline-light border-opacity-25" type="submit">
                            <i class="bi bi-search"></i>
                        </button>
                    </div>
                </form>

                <div class="navbar-text text-light d-flex align-items-center gap-3">
                    <small class="d-none d-lg-inline"><i class="bi bi-building"></i> <?= e(getParam('nom_entreprise', 'Mon Activité')) ?></small>
                    <div class="dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-menu-end shadow-lg p-0" style="min-width: 230px;">
